...
class Config:
    ...
    ### Model ###
    _name = None  # Name der Mesh Datei rein schreiben
    _scale = None

    ### External forces ###
    _use_gravity = None
    _gravity_vec = np.array([0,0,0]) # GUI? Monderlebnis?
    _magnetic_force = None # Interface Regler Werte
    _magnetic_dir = None  # GUI Änderung von Magnetfeldrichtung oben, unten, recht, links
    _b_field = None
    _initial_dipole_moment = None  # Was? How

    ### Material parameters ###
    _poisson_ratio = None
    _youngs_modulus = None
    _density = None
    _remanence = None # Einheit Teslaaaa, ändern in GUI hehe
