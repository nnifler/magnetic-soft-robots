...
#ifdef SOFA_BUILD_SOFA_COMPONENT_LINEARSOLVER
#  define SOFA_TARGET Sofa.Component.LinearSolver
...
{
	constexpr const char* MODULE_NAME = "Sofa.Component.LinearSolver";
