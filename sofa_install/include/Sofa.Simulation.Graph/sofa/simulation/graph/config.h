...
#define SOFASIMULATIONGRAPH_VERSION 24.06.00

#ifdef SOFA_BUILD_SOFA_SIMULATION_GRAPH
#  define SOFA_TARGET Sofa.Simulation.Graph
...
#define SOFA_ATTRIBUTE_DISABLED_DAGSIMULATION_GETSIMULATION() \
    ...
    "v23.12", "v24.06", "")
#endif // SOFA_BUILD_SOFA_SIMULATION_GRAPH
