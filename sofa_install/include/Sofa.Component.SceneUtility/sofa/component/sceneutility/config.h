...
#  define SOFA_TARGET Sofa.Component.SceneUtility
#  define SOFA_COMPONENT_SCENEUTILITY_API SOFA_EXPORT_DYNAMIC_LIBRARY
#else
...
{
	constexpr const char* MODULE_NAME = "Sofa.Component.SceneUtility";
