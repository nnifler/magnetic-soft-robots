...
#define SOFA_TESTING_VERSION 24.06.00

//constexpr std::string with C++20 only
constexpr char SOFA_TESTING_RESOURCES_DIR[] = "/builds/workspace/sofa-custom/refs/heads/v24.06/ubuntu_gcc_release_full_python3.10/src/Sofa/framework/Testing/resources";
