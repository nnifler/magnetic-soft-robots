...
#define SOFA_ENABLE_SCOPED_ADVANCED_TIMER
...
#define SOFA_EXTERN_TEMPLATE SOFA_PRAGMA_ERROR("The usage of SOFA_EXTERN_TEMPLATE is now disabled. See commit 41e0ab9 for more information")
