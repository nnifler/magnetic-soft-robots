...
#ifdef SOFA_BUILD_SOFA_GUI_COMPONENT
#  define SOFA_TARGET Sofa.GUI.Component
#  define SOFA_GUI_COMPONENT_API SOFA_EXPORT_DYNAMIC_LIBRARY
#else
...
{
	constexpr const char* MODULE_NAME = "Sofa.GUI.Component";
